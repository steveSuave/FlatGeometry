...
void main() {
  group('GeometryApp', () {
    testWidgets('should render with light theme by default', (WidgetTester tester) async {
  ...
  group('GeometryCanvas', () {
    testWidgets('should start with point tool selected by default', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: GeometryCanvas(toggleTheme: () {}),
      ));
      ...
      final pointButtonIcon = tester.widget<Icon>(
        find.descendant(of: find.ancestor(of: pointToolButton, matching: find.byType(ToolButton)), 
        matching: find.byType(Icon))
      );
      expect(pointButtonIcon.color, isNot(Colors.grey));
    });
    
    testWidgets('should change tool when tool button is pressed', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: GeometryCanvas(toggleTheme: () {}),
      ));
      ...
      final lineButtonIcon = tester.widget<Icon>(
        find.descendant(of: find.ancestor(of: lineToolButton, matching: find.byType(ToolButton)), 
        matching: find.byType(Icon))
      );
      expect(lineButtonIcon.color, isNot(Colors.grey));
    });
    
    testWidgets('should create point on canvas tap', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: GeometryCanvas(toggleTheme: () {}),
      ));
      ...
      final customPaint = tester.widget<CustomPaint>(find.byKey(const Key('geometry_canvas')));
    ...
    testWidgets('should handle keyboard shortcuts for tools', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: GeometryCanvas(toggleTheme: () {}),
      ));
      ...
      final lineButtonIcon = tester.widget<Icon>(
        find.descendant(
          of: find.ancestor(of: lineToolButton, matching: find.byType(ToolButton)), 
          matching: find.byType(Icon)
        )
      );
    ...
    testWidgets('should create line with two taps', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: GeometryCanvas(toggleTheme: () {}),
      ));
  ...
  group('ToolButton', () {
    ...
    testWidgets('should not be highlighted when not selected', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          body: ToolButton(
            icon: Icons.circle_outlined,
  ...
  group('GeometryPainter', () {
    test('shouldRepaint returns true when inputs change', () {
      ...
      // Test objects change
      expect(painter1.shouldRepaint(GeometryPainter(objects2, offset1, 1.0)), true);
      
      // Test pan offset change
      expect(painter1.shouldRepaint(GeometryPainter(objects1, offset2, 1.0)), true);
      
      // Test zoom change
      expect(painter1.shouldRepaint(GeometryPainter(objects1, offset1, 2.0)), true);
      
      // Test no change
      expect(painter1.shouldRepaint(GeometryPainter(objects1, offset1, 1.0)), false);
    });
  });
}